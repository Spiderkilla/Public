...
if ($BrokenVMSKU -like "*2016-Datacenter*")
    ...
    $Win2022DefaultSku = "2022-datacenter-azure-edition"
    ...
    Write-Host ""
    Write-Host "3: Create VM '$RescueVmName' from generation 2 Windows Server 2022 Azure Edition default image"
    Write-Host ""
    ...
    Write-Host "==================================================================================================================================================================================================================="
     ...
     switch ($selection)
     {
           ...
           '3' {Write-host "You chose option #3. VM '$RescueVmName' will be created from generation 2 Windows Server 2022 Azure Edition default image" -ForegroundColor green}
...
if ($BrokenVMSKU -like "*2022-datacenter-azure-edition*")
    {
    #Windows Server 2016
    $Win2016DefaultPublisher = "MicrosoftWindowsServer"
    $Win2016DefaultOffer = "WindowsServer"
    ...
    Write-Host "2: Create VM '$RescueVmName' from generation 1 Windows Server 2019 default image"
    Write-Host ""
    Write-Host "3: Create VM '$RescueVmName' from generation 2 Windows Server 2022 Azure Edition default image" -ForegroundColor DarkGray; 
    Write-Host "   (Option not supported. Rescue VM cannot have the same OS version as the affected one)" -ForegroundColor red
    Write-Host ""
    Write-Host "Q: Press 'Q' to quit."
    Write-Host ""
