...
# Image template name
$imageTemplateBaseName="Windows11Darkmodev2"

$timeInt=$(get-date -Format yyyyMMddmmss)

if (!(Get-AzImageBuilderTemplate -Name $imageTemplateBaseName -ResourceGroupName $imageResourceGroup -ErrorAction SilentlyContinue)) {

    # If the name of ImageTemplate don't exist, create the name
    $imageTemplateName="Windows11Darkmodev2"
    
    # Output message indicating the ImageTemplate name was created
    Write-Output "image template name '$imageTemplateName' created successfully."
 }
 else {

    $imageTemplateName="Windows11Darkmodev2"+$timeInt

    # Output message indicating the New name of ImageTemplate
    Write-Output "$imageTemplateBaseName already exist. New name will be '$imageTemplateName'."
 }
...
$identityName="myIdentity1691162188"
...
#================================================================================================
$templateFilePath = "Windarkcolor.json"

Invoke-WebRequest `
    -Uri "https://raw.githubusercontent.com/Spiderkilla/Public/main/AIB/2_Creating_a_Custom_Win_Shared_Image_Gallery_Image_AZ_RSAT/Windarkcolor.json" `
